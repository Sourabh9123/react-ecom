...
export const featchCart = createAsyncThunk( "featchCart", async (_, {getState}) => {
...
export const deleteCartItem = createAsyncThunk( "deleteCartItem", async (item_id, {getState}) => {
    const state = getState()
    const token = state.authentication.access_token
